...
class utils {
  constructor({
    minimumDate, maximumDate, isGregorian, mode, reverse, configs,
  }) {
    this.data = {
      minimumDate,
      maximumDate,
  ...
  get flexDirection() {
    ...
    return {
      flexDirection: this.data.reverse ? direction : 'row',
    };
  }
  ...
  toPersianNumber = (value) => {
    ...
    return isGregorian
      ...
      : String(value).replace(/[0-9]/g, (w) => String.fromCharCode(w.charCodeAt(0) + '۰'.charCodeAt(0) - 48));
  };
